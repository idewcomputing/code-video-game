...
* **RULE:**  Variable names **cannot** be a [reserved keyword in the coding language](https://www.w3schools.com/js/js\_reserved.asp).
...
![](<../../.gitbook/assets/hello-phaser-logo1-preview (1).jpg>)
...
![](<../../.gitbook/assets/hello-phaser-logo2-preview (1).jpg>)
