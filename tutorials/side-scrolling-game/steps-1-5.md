...
This code creates a local variable named `coinData` which is an array containing [JSON data](https://www.w3schools.com/js/js\_json\_syntax.asp) for each coin to be added to the game.
